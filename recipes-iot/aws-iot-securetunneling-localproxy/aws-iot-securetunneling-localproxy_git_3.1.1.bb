...
BRANCH ?= "joe-ng-testing"

PV = "3.1.1+git${SRCPV}"
SRC_URI = "git://github.com/eguanatech/aws-iot-securetunneling-localproxy.git;protocol=https;branch=${BRANCH};rev=6fca5266e58baed9ad1ac1c5760144092a528cd6 \
