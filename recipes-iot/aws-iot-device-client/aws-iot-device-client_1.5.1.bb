...
PACKAGES_${PN} += "aws-crt-cpp"
PREFERRED_RPROVIDER_${PN} += "aws/crt-cpp"
...
FILES_${PN} += "${base_sbindir}/aws-iot-device-client"
FILES_${PN} += "${systemd_user_unitdir}/aws-iot-device-client.service"
FILES_${PN} += "${sysconfdir}/aws-iot-device-client.json"
FILES_${PN} += "${sysconfdir}/init.d/aws-iot-device-client"
